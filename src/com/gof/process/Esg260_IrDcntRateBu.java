...
//			log.info("{}", spotList);
			...
			if(curveSwMap.getKey().equals("1010000")) {
				spotList.forEach(s-> log.info("Spot : {},{}", s.toString()));
			}
...
//						double shkCont      = applBizDv.equals("KICS")  ? irSprdShkMap.getOrDefault(spot.getMatCd(), 0.0)  : 0.0;
						...
						double shkCont      = swSce.getValue().getShkSprdSceNo() < 7 ? irSprdShkMap.getOrDefault(spot.getMatCd(), 0.0)  : 0.0;
