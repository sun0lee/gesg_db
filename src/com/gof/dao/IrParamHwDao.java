...
//					  .setParameter("irModelId", "%"+irModelId+"%")
	...
	public static List<IrParamHwCalc> getIrParamHwCalcHisList(String bssd) {
	...
	public static List<IrParamHwBiz> getIrParamHwBizList(String bssd) {
	...
	public static List<IrParamAfnsBiz> getIrParamAfnsBizList(String bssd) {

		String query = " select a from IrParamAfnsBiz a    "
				 	 + "  where 1=1                      "
				 	 + "    and a.baseYymm  = :bssd      "
				 	 ;

		return session.createQuery(query, IrParamAfnsBiz.class)
				      .setParameter("bssd", bssd)
				      .getResultList();
	}
	public static List<IrParamAfnsCalc> getIrParamAfnsCalcList(String bssd) {
