...
//				      .setParameter("irModelId" , "%"+irModelId+"%")
	...
	public static List<IrParamModel> getParamModelList() {
	...
	public static List<IrParamModelBiz> getParamModelBizList(String bssd) {
	...
	public static List<IrParamModelCalc> getIrParamModelCalcList(String bssd) {
