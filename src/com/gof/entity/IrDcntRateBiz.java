...
@AllArgsConstructor
@Builder
public class IrDcntRateBiz implements Serializable, EntityIdentifier, Comparable<IrDcntRateBiz> {
	...
	@Override
	public int compareTo(IrDcntRateBiz other) {
//		return this.baseYymm.compareTo(other.getBaseYymm());
