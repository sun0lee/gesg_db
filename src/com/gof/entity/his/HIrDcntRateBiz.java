...
@Entity
@Table(name ="E_IRH_DCNT_RATE_BIZ")
@NoArgsConstructor
@Getter
@Setter
@EqualsAndHashCode
...
@AllArgsConstructor
@Builder
public class HIrDcntRateBiz implements Serializable, EntityIdentifier, HisEntity<IrDcntRateBiz> {
	...
	public static HIrDcntRateBiz convertFrom(IrDcntRateBiz from, String baseYymm, int seq) {
	...
	@Override
	public IrDcntRateBiz convertToBiz(String baseYymm, int seq) {
		return IrDcntRateBiz.builder()
